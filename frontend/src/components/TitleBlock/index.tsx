  ...
  return (
    <section className="container-fluid relative">
      <div
        ...
        <div className="title col-span-full max-w-[1165px] text-4xl font-bold md:col-span-8 xl:text-5xl 2xl:leading-[67px]   3xl:col-span-8 [&>*]:text-4xl [&>*]:tracking-tight xl:[&>*]:text-5xl 2xl:[&>*]:leading-[67px]">
          {title && parse(title)}
        </div>
        {haveShape && (
          <TitleShape
