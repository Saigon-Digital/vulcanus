...
const blocks = new Map<Block["__typename"], React.FC<any> | any>([
  ...
  ["PageBuilderDynamicBlocksImageContent", ImageContent],
  ["PageBuilderDynamicBlocksCenterTitleText", CenterTitleText],
  ...
  ["PageBuilderDynamicBlocksPrivacyPolicy", PrivacyPolicy],
]);
